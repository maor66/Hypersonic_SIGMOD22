...
public class PatternConfig {
	...
	private static final PatternSpecification iterPatternSensorSEQ6 =
			buildIterSensorActivityChangegSpecificationFromActivities("IterSensorSEQ6",
					new String[] {
 							SensorEventTypeManager.entertainGuestsEventTypeName,
							SensorEventTypeManager.drinkEventTypeName,
							SensorEventTypeManager.workOnComputerEventTypeName,
							SensorEventTypeManager.toiletEventTypeName,
							SensorEventTypeManager.cookEventTypeName	,
							SensorEventTypeManager.stepOutEventTypeName,
					}
			);
	private static final PatternSpecification basicPatternSensorSEQ6 =
			buildSequenceSensorActivityChangegSpecificationFromActivities("basicSensorSEQ6",
					new String[] {
							SensorEventTypeManager.sleepEventTypeName,
							SensorEventTypeManager.drinkEventTypeName,
							SensorEventTypeManager.toiletEventTypeName,
							SensorEventTypeManager.cookDinnerEventTypeName,
							SensorEventTypeManager.eatDinnerEventTypeName,
							SensorEventTypeManager.washDinnerDishesEventTypeName,
					}
			);
			...
			new PatternSpecification("SEQ6", PatternTypes.STOCK_PATTERN, stockByCompanyPatternTimeWindow,
					...
					new ConditionSpecification[] {
							new StockDeltaOrderingFusedFirstConditionSpecification(
									StockEventTypesManager.etfcEventTypeName,
									StockEventTypesManager.intelEventTypeName + StockEventTypesManager.fslrEventTypeName),
							new TimestampFusedComparisonConditionSpecification(
									StockEventTypesManager.etfcEventTypeName,
									StockEventTypesManager.intelEventTypeName + StockEventTypesManager.fslrEventTypeName),
							...
							new StockDeltaOrderingFusedSecondConditionSpecification(
									StockEventTypesManager.intelEventTypeName + StockEventTypesManager.fslrEventTypeName,
									StockEventTypesManager.googleEventTypeName),
							new StockCorrelationConditionSpecification(
									StockEventTypesManager.googleEventTypeName,
									StockEventTypesManager.biduEventTypeName,
									0.1),
							new StockCorrelationConditionSpecification(
	...
	private static final PatternSpecification basicFusedPatternSEQ6_unfused =
			new PatternSpecification("SEQ6", PatternTypes.STOCK_PATTERN, stockByCompanyPatternTimeWindow,
					new String[][][] {new String[][]{new String[]{
							StockEventTypesManager.etfcEventTypeName,
...
//									StockEventTypesManager.fslrEventTypeName),
	...
	private static PatternSpecification buildIterSensorActivityChangegSpecificationFromActivities(String patternName, String[] eventTypeNames) {
		return new PatternSpecification(patternName, PatternTypes.SENSOR_PATTERN, sensorPatternTimeWindow,
				new String[][][] {new String[][]{
						eventTypeNames,
				}},
				null,
				new String[] {eventTypeNames[eventTypeNames.length - 1]},
				createIterSensorActivityChangeConditionSpecificationFromActivities(eventTypeNames).toArray(new ConditionSpecification[0]),
				SlaVerifierTypes.NONE);
	}

	private static List<ConditionSpecification> createIterSensorActivityChangeConditionSpecificationFromActivities(String[] eventTypeNames) {
		List<ConditionSpecification> conditionSpecifications = new ArrayList<>();
		int patternSize = eventTypeNames.length;
		...
		conditionSpecifications.add(new IterativeSensorActivityChangeConditionSpecification(
				eventTypeNames[patternSize - 2],
				eventTypeNames[patternSize - 1],
				null));
...
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(40),
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(20),
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(30),
			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(45),
			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(50),
			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(55),
			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(60),
			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(65),
			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(70),
			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(75),
			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(80),
			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(85),
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(90),
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(100),
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(40),
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(50),
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(60),
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(70),
...
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(90),
//			basicFusedPatternSEQ6.createIdenticalSpecificationWithDifferentWindow(100),
//			basicFusedPatternSEQ6_unfused.createIdenticalSpecificationWithDifferentWindow(110),
//			basicFusedPatternSEQ6_unfused.createIdenticalSpecificationWithDifferentWindow(120),
...
//			basicPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(30),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(30),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(40),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(50),
			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(60),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(70),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(80),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(90),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(95),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(100),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(105),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(110),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(115),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(120),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(125),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(130),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(135),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(140),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(145),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(150),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(155),
//			iterPatternSensorSEQ6.createIdenticalSpecificationWithDifferentWindow(200),
