...
public class SimulationConfig {
	...
	//sase.specification creator definition
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/* Settings for sase.pattern sase.specification generation. */
	...
	public static final InputSpecification[] inputSpecifications = {
			//Experiments 1-8
			///////////////////////////////////////////////////////////////////////no sase.input modification
			new TrivialInputSpecification(),
			/////////////////////////////////////////////////////////////////////////////////////////////////////			
			
			//Experiment 9
			///////////////////////////////////////////////////////////////////////sase.input modification
...
//					0.0, WorkloadManagerTypes.MULTI_STATIC, 0.5, 0.001),
	...
	/* Individual sase.specification sets for cross-combining. */
...
//				NeighborhoodTypes.PAIRWISE, (long)10, 0, 10000000, 0.99, 1000),
		...
		//intentionally commented out sase.multi-tree configurations - if needed, all experiments will be repeated on them
...
//				1000, 0,//time between sase.input changes
//				0),//no sase.input modification
//		new InputSpecification(numberOfSyntheticEvents, numberOfSyntheticEventTypes,
...
//				1.0, 0.0,//arrival rates change range
//				0.1, 0.0,//selectivities change range 
//				50, 0,//time between sase.input changes
//				1),
//		new InputSpecification(numberOfSyntheticEvents, numberOfSyntheticEventTypes,
//				0.2, 5.0,//arrival rates range 
//				0.02, 0.5,//selectivities range
...
//				1.0, 0.0,//arrival rates change range
//				0.1, 0.0,//selectivities change range 
//				100, 0,//time between sase.input changes
//				1),
//		new InputSpecification(numberOfSyntheticEvents, numberOfSyntheticEventTypes,
//				0.2, 5.0,//arrival rates range 
//				0.02, 0.5,//selectivities range
...
//				1.0, 0.0,//arrival rates change range
//				0.1, 0.0,//selectivities change range 
//				500, 0,//time between sase.input changes
//				1),
//		new InputSpecification(numberOfSyntheticEvents, numberOfSyntheticEventTypes,
//				0.2, 5.0,//arrival rates range 
//				0.02, 0.5,//selectivities range
...
//				1.0, 0.0,//arrival rates change range
//				0.1, 0.0,//selectivities change range 
//				5000, 0,//time between sase.input changes
//				1),
//		new InputSpecification(numberOfSyntheticEvents, numberOfSyntheticEventTypes,
//				0.2, 5.0,//arrival rates range 
//				0.02, 0.5,//selectivities range
...
//				1.0, 0.0,//arrival rates change range
//				0.1, 0.0,//selectivities change range 
//				10000, 0,//time between sase.input changes
//				1),
//	};
