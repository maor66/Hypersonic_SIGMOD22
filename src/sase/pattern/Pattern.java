...
/**
 * This class represents a single sase.pattern whose instances the sase.user is willing to detect.
 */
public abstract class Pattern {
	...
	private void validatePatternType()
	{
		...
		throw new RuntimeException(String.format("Illegal operator for sase.pattern of type %s: %s",
