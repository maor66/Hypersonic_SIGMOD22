...
//		}
	...
	public Node getParent() {
		if (isMultiTreeNode()) {
			throw new RuntimeException("Unexpected usage of getParent() in a sase.multi-tree");
		}
	...
	public void setParent(Node parent) {
		if (isMultiTreeNode()) {
			throw new RuntimeException("Unexpected usage of setParent() in a sase.multi-tree");
		}
		parents.clear();
		parents.add(parent);
	...
	public Node getPeer() {
		if (isMultiTreeNode()) {
			throw new RuntimeException("Unexpected usage of getPeer() in a sase.multi-tree");
		}
		if (parents.isEmpty()) {
			return null;
		}
	...
	public CNFCondition getMainCondition() {
		if (isMultiTreeNode()) {
			throw new RuntimeException("Unexpected usage of getMainCondition() in a sase.multi-tree");
		}
	...
	public void finalizeTree() {
		if (isMultiTreeNode()) {
			throw new RuntimeException("Unexpected usage of finalizeNode() in a sase.multi-tree");
		}
		finalizeNode(null);
	}
