...
public class ParallelLazyChainNFA extends LazyChainNFA {
    ...
    private List<Match> findPartialMatchesOnNewPartialMatch(TypedNFAState eventState, Match partialMatch) {
        return findPartialMatchesInCurrentState(eventState, getSlice(parallelInputBuffer.get(eventState), partialMatch, eventState), new ArrayList<>(List.of(partialMatch)));
    }
